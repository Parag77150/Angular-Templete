...
export interface WorkerRequestEvent<EventType> {
     ...
     */
    body: EventType extends WorkerEvents.Callable ? WorkerCallableBody : EventType extends WorkerEvents.Accessable ? WorkerAccessableBody : EventType extends WorkerEvents.Observable ? WorkerSubscribableBody : null;
}
/**
...
/**
  ...
  */
export declare enum WorkerObservableMessageTypes {
    Next = 1,
    Error = 2,
    Complete = 3
}
