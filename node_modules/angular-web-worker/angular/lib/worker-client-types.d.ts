...
export interface WorkerClientRequestOpts<T, EventType extends number, ReturnType> {
     ...
     */
    body?: (secretResult?: SecretResult<EventType>, additionalContext?: any) => EventType extends WorkerEvents.Callable ? WorkerCallableBody : EventType extends WorkerEvents.Accessable ? WorkerAccessableBody : EventType extends WorkerEvents.Observable ? WorkerSubscribableBody : null;
    /**
